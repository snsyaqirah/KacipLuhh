...
import { roomCreateLimiter, roomJoinLimiter, roomExtendLimiter, reportLimiter } from '../middleware/rateLimit.middleware.js';
...
router.post('/:id/report', reportLimiter, handleReport);
